...
Route::get('/yori-adminpanel', [DashboardController::class, 'index'])->name('home');
...
Route::middleware([AccessControl::class])->group(function () {
    ...
    Route::get('/yoriadminpanel/main/task/approve/{id}', [TaskController::class, 'approve'])->name('task-approve');
