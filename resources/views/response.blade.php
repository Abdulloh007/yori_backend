          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
              <table class="table align-items-center justify-content-center mb-0">
                <a href="{{ route('response-create') }}" class="text-white font-weight-bold text-xs mx-3 px-3 py-1" style="background: var(--bs-success);border-radius: 5px;">Add</a>
                <thead>
                  <tr>
                ...
                <tbody>
                    ...
                    <td>
                      <div class="d-flex px-3">
                          <h6 class="mb-0 text-sm"><a href="{{ route('users-show',$response->task)}}" target="blank">{{ $response->task_title }}</a></h6>
                      </div>
                    </td>
                    <td>
                      <div class="d-flex px-3">
