                ...
                <tbody>
                    ...
                    <td>
                      <div class="d-flex px-3">
                          <h6 class="mb-0 text-sm"><a href="{{ route('users-show',$item->sender) }}">{{ $item->sender_name }}</a></h6>
                      </div>
                    </td>
                    <td>
                      <div class="d-flex px-3">
                    ...
                    <td>
                        <a href="{{ route('message-delete',$item->id) }}" class="text-white font-weight-bold text-xs px-3 py-1" style="background: var(--bs-red);border-radius: 5px;">Delete</a>
                    </td>
                  </tr>
                    @empty
                        <tr><td><h6 class="mb-0 text-sm px-3">Messages Not Found</h6><td></tr>
                    @endforelse
                </tbody>
              </table>
            </div>
