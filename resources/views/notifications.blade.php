            ...
            <div class="table-responsive p-0">
              <table class="table align-items-center justify-content-center mb-0">
                ...
                <tbody>
                    ...
                    <td>
                      <div class="d-flex px-3">
                          <h6 class="mb-0 text-sm"><a href="{{ route('users-show',$item->user_id) }}">{{ $item->user_name }}</a></h6>
                      </div>
                    </td>
                    <td>
                      <div class="d-flex px-3">
                    ...
                    <td>
                        <a href="{{ route('notification-delete',$item->id) }}" class="text-white font-weight-bold text-xs px-3 py-1" style="background: var(--bs-red);border-radius: 5px;">Delete</a>
                    </td>
                  </tr>
                    @empty
                        <tr><td><h6 class="mb-0 text-sm px-3">Notifications Not Found</h6><td></tr>
                    @endforelse
                </tbody>
              </table>
            </div>
